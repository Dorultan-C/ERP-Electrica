...
export const permissions: Permission[] = [
  ...
  // HR - Schedules: Manage other's schedules
  {
    id: "hr-schedules-manage",
    name: "Schedules Management",
    description:
      "Permission to view/assign/create/delete/edit other's permissions",
    moduleId: "hr",
    sectionId: "schedules",
    actions: ["read", "assign", "create", "update", "delete"],
  },
